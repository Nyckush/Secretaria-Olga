...
{
    /**
     * Normaliza texto para comparación insensible a acentos y signos.
     */
    ...
    {
        $map = config('horas_catedra', []);
        if (empty($map)) {
            $this->command->info('No se encontraron horas en config/horas_catedra.php');
            return;
        }
